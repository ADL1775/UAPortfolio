...
typedef struct film ItemData;       // This is the structure above (struct film)


// Each node in this linked list contains a title and number of stars per movie
typedef struct node
{
    ItemData itemData;
    struct node * pNext;
...
// typedef Node *List;  // Old way of managing data.

// Added this.
typedef struct list 
{
    Node *pHead;    // Points to head of list
    Node *pTail;    // Points to end of list
